...
export default function Imprint() {
  return (
    <UtilityPageWrapper>
      ...
      <p className="mt-10 lg:max-w-[40vw] text-center">Bei ampass.at handelt es sich um eine &quotkleine Website&quot. Folgende Kontaktinformationen sind ausreichend für die Offenlegungspflicht.</p>
